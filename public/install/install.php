...
try {
    switch ($action) {
        ...
        case 'install':
            ...
            $admin_language = $_POST['admin_language'] ?? 'en-US';
            ...
            $pdo->exec("UPDATE settings SET `value` = " . $pdo->quote($admin_language) . " WHERE `key` = 'admin_language'");
            $logs[] = "站点语言设置: $site_language, 后台语言: $admin_language";
